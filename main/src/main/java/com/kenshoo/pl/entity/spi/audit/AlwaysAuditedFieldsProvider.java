...
/**
 * For a given entity type, provides additional fields from other entities that should always be added to {@link com.kenshoo.pl.entity.audit.AuditRecord}-s of the given entity.<br>
