...
class RecordReader {
    ...
    static <E extends EntityType<E>, T> Identifier<E> createKey(Record record, AliasedKey<E> aliasedKey) {
    ...
    static <E extends EntityType<E>, T> EntityImpl createEntity(Record record, Collection<? extends EntityField<?, ?>> fields) {
    ...
    static <E extends EntityType<E>> FieldsValueMap<E> createFieldsValueMap(Record record, List<? extends EntityField<E, ?>> fields) {
