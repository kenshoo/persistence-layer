...
public class UpdateTestEntityCommand extends UpdateEntityCommand<TestEntityType, Identifier<TestEntityType>>
    implements EntityCommandExt<TestEntityType, UpdateTestEntityCommand> {
